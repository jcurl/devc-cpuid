...
TEST(GetCpuId, AuthenticAMD_K17_Matisse_11)
{
    // The following data is taken from an AMD K17 results from the Internet.
    std::shared_ptr<tree::CpuIdTree> tree = std::make_shared<tree::CpuIdTree>();
    tree::CpuIdProcessor cpu0{};

    cpu0.AddLeaf(CpuIdRegister{0x00000000, 0x00000000, 0x00000010, 0x68747541, 0x444D4163, 0x69746E65});
    cpu0.AddLeaf(CpuIdRegister{0x00000001, 0x00000000, 0x00870F10, 0x000C0800, 0x7ED8320B, 0x178BFBFF});
    cpu0.AddLeaf(CpuIdRegister{0x00000002, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000});
    cpu0.AddLeaf(CpuIdRegister{0x00000003, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000});
    cpu0.AddLeaf(CpuIdRegister{0x00000005, 0x00000000, 0x00000040, 0x00000040, 0x00000003, 0x00000011});
    cpu0.AddLeaf(CpuIdRegister{0x00000006, 0x00000000, 0x00000004, 0x00000000, 0x00000001, 0x00000000});
    cpu0.AddLeaf(CpuIdRegister{0x00000007, 0x00000000, 0x00000000, 0x219C91A9, 0x00400004, 0x00000000});
    cpu0.AddLeaf(CpuIdRegister{0x00000008, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000});
    cpu0.AddLeaf(CpuIdRegister{0x00000009, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000});
    cpu0.AddLeaf(CpuIdRegister{0x0000000A, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000});
    cpu0.AddLeaf(CpuIdRegister{0x0000000B, 0x00000000, 0x00000001, 0x00000002, 0x00000100, 0x00000000});
    cpu0.AddLeaf(CpuIdRegister{0x0000000B, 0x00000001, 0x00000007, 0x0000000C, 0x00000201, 0x00000000});
    cpu0.AddLeaf(CpuIdRegister{0x0000000C, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000});
    cpu0.AddLeaf(CpuIdRegister{0x0000000D, 0x00000000, 0x00000207, 0x00000340, 0x00000380, 0x00000000});
    cpu0.AddLeaf(CpuIdRegister{0x0000000D, 0x00000001, 0x0000000F, 0x00000340, 0x00000000, 0x00000000});
    cpu0.AddLeaf(CpuIdRegister{0x0000000D, 0x00000002, 0x00000100, 0x00000240, 0x00000000, 0x00000000});
    cpu0.AddLeaf(CpuIdRegister{0x0000000D, 0x00000009, 0x00000040, 0x00000340, 0x00000000, 0x00000000});
    cpu0.AddLeaf(CpuIdRegister{0x0000000E, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000});
    cpu0.AddLeaf(CpuIdRegister{0x0000000F, 0x00000000, 0x00000000, 0x000000FF, 0x00000000, 0x00000002});
    cpu0.AddLeaf(CpuIdRegister{0x0000000F, 0x00000001, 0x00000000, 0x00000040, 0x000000FF, 0x00000007});
    cpu0.AddLeaf(CpuIdRegister{0x00000010, 0x00000000, 0x00000000, 0x00000002, 0x00000000, 0x00000000});
    cpu0.AddLeaf(CpuIdRegister{0x00000010, 0x00000001, 0x0000000F, 0x00000000, 0x00000004, 0x0000000F});
    cpu0.AddLeaf(CpuIdRegister{0x80000000, 0x00000000, 0x80000020, 0x68747541, 0x444D4163, 0x69746E65});
    cpu0.AddLeaf(CpuIdRegister{0x80000001, 0x00000000, 0x00870F10, 0x20000000, 0x75C237FF, 0x2FD3FBFF});
    cpu0.AddLeaf(CpuIdRegister{0x80000002, 0x00000000, 0x20444D41, 0x657A7952, 0x2035206E, 0x30303633});
    cpu0.AddLeaf(CpuIdRegister{0x80000003, 0x00000000, 0x2D362058, 0x65726F43, 0x6F725020, 0x73736563});
    cpu0.AddLeaf(CpuIdRegister{0x80000004, 0x00000000, 0x2020726F, 0x20202020, 0x20202020, 0x00202020});
    cpu0.AddLeaf(CpuIdRegister{0x80000005, 0x00000000, 0xFF40FF40, 0xFF40FF40, 0x20080140, 0x20080140});
    cpu0.AddLeaf(CpuIdRegister{0x80000006, 0x00000000, 0x48006400, 0x68006400, 0x02006140, 0x01009140});
    cpu0.AddLeaf(CpuIdRegister{0x80000007, 0x00000000, 0x00000000, 0x0000001B, 0x00000000, 0x00006799});
    cpu0.AddLeaf(CpuIdRegister{0x80000008, 0x00000000, 0x00003030, 0x010CB657, 0x0000700B, 0x00010000});
    cpu0.AddLeaf(CpuIdRegister{0x80000009, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000});
    cpu0.AddLeaf(CpuIdRegister{0x8000000A, 0x00000000, 0x00000001, 0x00008000, 0x00000000, 0x0013BCFF});
    cpu0.AddLeaf(CpuIdRegister{0x8000000B, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000});
    cpu0.AddLeaf(CpuIdRegister{0x8000000C, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000});
    cpu0.AddLeaf(CpuIdRegister{0x8000000D, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000});
    cpu0.AddLeaf(CpuIdRegister{0x8000000E, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000});
    ...
    cpu0.AddLeaf(CpuIdRegister{0x80000017, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000});
    cpu0.AddLeaf(CpuIdRegister{0x80000018, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000});
    cpu0.AddLeaf(CpuIdRegister{0x80000019, 0x00000000, 0xF040F040, 0x00000000, 0x00000000, 0x00000000});
    cpu0.AddLeaf(CpuIdRegister{0x8000001A, 0x00000000, 0x00000006, 0x00000000, 0x00000000, 0x00000000});
    cpu0.AddLeaf(CpuIdRegister{0x8000001B, 0x00000000, 0x000003FF, 0x00000000, 0x00000000, 0x00000000});
    cpu0.AddLeaf(CpuIdRegister{0x8000001C, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000});
    cpu0.AddLeaf(CpuIdRegister{0x8000001D, 0x00000000, 0x00004121, 0x01C0003F, 0x0000003F, 0x00000000});
    cpu0.AddLeaf(CpuIdRegister{0x8000001D, 0x00000001, 0x00004122, 0x01C0003F, 0x0000003F, 0x00000000});
    cpu0.AddLeaf(CpuIdRegister{0x8000001D, 0x00000002, 0x00004143, 0x01C0003F, 0x000003FF, 0x00000002});
    cpu0.AddLeaf(CpuIdRegister{0x8000001D, 0x00000003, 0x00014163, 0x03C0003F, 0x00003FFF, 0x00000001});
    cpu0.AddLeaf(CpuIdRegister{0x8000001E, 0x00000000, 0x00000000, 0x00000100, 0x00000000, 0x00000000});
    cpu0.AddLeaf(CpuIdRegister{0x8000001F, 0x00000000, 0x0001000F, 0x0000016F, 0x000001FD, 0x00000001});
    cpu0.AddLeaf(CpuIdRegister{0x80000020, 0x00000000, 0x00000000, 0x00000002, 0x00000000, 0x00000000});
    tree->SetProcessor(0, cpu0);
    ...
    auto cpuid0 = factory->create(0);
    auto cpureg00 = cpuid0->GetCpuId(0, 0);
    ASSERT_EQ(cpureg00.Eax(), 0x00000010);
	auto cpureg80 = cpuid0->GetCpuId(0x80000000, 0);
    ASSERT_EQ(cpureg80.Eax(), 0x80000020);
