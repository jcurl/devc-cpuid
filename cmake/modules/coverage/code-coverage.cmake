...
# 2022-10-29, jcurl:
#   We instead do some more advanced checks, and don't abort if we don't have all
#   the tools necessary.
# option(
#   CODE_COVERAGE
...
# 2022-10-29, jcurl:
#   Check that the tools are all available before we execute the main logic.
...
if(CMAKE_CXX_COMPILER_ID MATCHES "(Apple)?[Cc]lang")
  if(NOT LLVM_COV_PATH)
    message(STATUS "Building with LLVM code coverage not enabled (missing llvm-cov)")
  else()
    set(ENABLE_COVERAGE "LLVM")
  endif()
elseif(CMAKE_CXX_COMPILER_ID MATCHES "GNU")
  if(NOT LCOV_PATH)
    message(STATUS "Building with LCOV code coverage not enabled (missing lcov)")
  elseif(NOT GENHTML_PATH)
    message(STATUS "Building with LCOV code coverage not enabled (missing genhtml)")
  else()
    set(ENABLE_COVERAGE "LCOV")
  endif()
endif()

cmake_dependent_option(CODE_COVERAGE
  "Builds targets with code coverage instrumentation. (Requires GCC or Clang)" OFF
  "ENABLE_TEST;ENABLE_COVERAGE" OFF)

if(CODE_COVERAGE)
  message(STATUS "Building with ${ENABLE_COVERAGE} code coverage enabled")
else()
  if((CMAKE_CXX_COMPILER_ID MATCHES "(Apple)?[Cc]lang") OR
     (CMAKE_CXX_COMPILER_ID MATCHES "GNU"))
    if(ENABLE_COVERAGE)
      message(STATUS "Building with ${ENABLE_COVERAGE} code coverage not enabled (enable testing and coverage)")
    endif()
  else()
    message(STATUS "LLVM/LCOV not available for the compiler ${CMAKE_CXX_COMPILER_ID}")
    set(CODE_COVERAGE OFF)
  endif()
endif()
# 2022-10-29, jcurl: done.
...
if(CODE_COVERAGE AND NOT CODE_COVERAGE_ADDED)
  ...
  if(CMAKE_C_COMPILER_ID MATCHES "(Apple)?[Cc]lang"
    ...
    # Messages
    # 2022-10-29, jcurl: Not needed, printed above.
  ...
  elseif(CMAKE_C_COMPILER_ID MATCHES "GNU" OR CMAKE_CXX_COMPILER_ID MATCHES
    ...
    # 2022-10-29, jcurl: Use ENABLE_DEBUG instead. Default is DEBUG mode
    #if(CMAKE_BUILD_TYPE)
